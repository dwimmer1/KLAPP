...
import java.util.List;
public class KlettersteigListFragment extends Fragment implements DataFetcher.OnDataFetchedListener {
    ...
    public View onCreateView(
       ...
       // dataFetcher.execute("http://192.168.56.1/Klapp/getData.php");
        dataFetcher.execute("https://klettersteig-app.at/daten/getDataKlapp.php");
        ...
        */
        ...
        binding.BtnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NavHostFragment.findNavController(KlettersteigListFragment.this)
